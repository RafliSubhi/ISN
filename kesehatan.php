...
<head>
    ...
    <title>ISCOPE | kesehatan | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita kesehatan dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM kesehatan ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/kesehatan/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita kesehatan">
                        <div class="content bg-dark">
                            <a href="kesehatan_lengkap.php?id=<?php echo $data['id']; ?>">
