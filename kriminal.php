...
<head>
    ...
    <title>ISCOPE | kriminal | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita kriminal dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM kriminal ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/kriminal/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita kriminal">
                        <div class="content bg-dark">
                            <a href="kriminal_lengkap.php?id=<?php echo $data['id']; ?>">
