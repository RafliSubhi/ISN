...
<head>
    ...
    <title>ISCOPE | olahraga | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita olahraga dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM olahraga ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/olahraga/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita olahraga">
                        <div class="content bg-dark">
                            <a href="olahraga_lengkap.php?id=<?php echo $data['id']; ?>">
