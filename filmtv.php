...
<head>
    ...
    <title>ISCOPE | filmtv | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita filmtv dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM filmtv ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/kultur/filmtv/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita filmtv">
                        <div class="content bg-dark">
                            <a href="filmtv_lengkap.php?id=<?php echo $data['id']; ?>">
