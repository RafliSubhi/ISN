...
<head>
    ...
    <title>Berita Lengkap | kriminal <?php echo htmlspecialchars($data['judul']); ?></title>
...
<body>
    <div class="container mt-3 col-9 mb-5">
        ...
        <img src="admin/kriminal/<?php echo htmlspecialchars($data['img']); ?>" class="card-img-top" alt="Image">
