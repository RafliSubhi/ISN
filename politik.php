...
<head>
    ...
    <title>ISCOPE | politik | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita politik dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM politik ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/politik/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita politik">
                        <div class="content bg-dark">
                            <a href="politik_lengkap.php?id=<?php echo $data['id']; ?>">
