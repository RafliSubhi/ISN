...
<head>
    ...
    <title>ISCOPE | sosialbudaya | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita sosialbudaya dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM sosialbudaya ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/sosialbudaya/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita sosialbudaya">
                        <div class="content bg-dark">
                            <a href="sosialbudaya_lengkap.php?id=<?php echo $data['id']; ?>">
