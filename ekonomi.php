...
<head>
    ...
    <title>ISCOPE | EKONOMI | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita ekonomi dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM ekonomi ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/ekonomi/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita Ekonomi">
                        <div class="content bg-dark">
                            <a href="ekonomi_lengkap.php?id=<?php echo $data['id']; ?>">
