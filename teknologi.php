...
<head>
    ...
    <title>ISCOPE | teknologi | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita teknologi dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM teknologi ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/teknologi/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita teknologi">
                        <div class="content bg-dark">
                            <a href="teknologi_lengkap.php?id=<?php echo $data['id']; ?>">
