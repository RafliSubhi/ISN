...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita seni dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM seni ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/seni/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita seni">
                        <div class="content bg-dark">
                            <a href="seni_lengkap.php?id=<?php echo $data['id']; ?>">
