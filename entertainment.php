...
<head>
    ...
    <title>ISCOPE | entertainment | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita entertainment dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM entertainment ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/kultur/entertainment/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita entertainment">
                        <div class="content bg-dark">
                            <a href="entertainment_lengkap.php?id=<?php echo $data['id']; ?>">
