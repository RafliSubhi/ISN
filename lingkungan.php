...
<head>
    ...
    <title>ISCOPE | lingkungan | NEWS</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            // Mengambil data berita lingkungan dari database
            $sql = mysqli_query($koneksi, "SELECT * FROM lingkungan ORDER BY tgl DESC");
            ...
            ?>
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="team-item">
                        <img src="admin/lingkungan/<?php echo htmlspecialchars($data['img']); ?>" alt="Berita lingkungan">
                        <div class="content bg-dark">
                            <a href="lingkungan_lengkap.php?id=<?php echo $data['id']; ?>">
