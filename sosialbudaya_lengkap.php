...
<head>
    ...
    <title>Berita Lengkap | sosialbudaya <?php echo htmlspecialchars($data['judul']); ?></title>
...
<body>
    <div class="container mt-3 col-9 mb-5">
        ...
        <img src="admin/sosialbudaya/<?php echo htmlspecialchars($data['img']); ?>" class="card-img-top" alt="Image">
