...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $jenis = 'entertainment'; // Default value for jenis
        ...
        if ($_FILES['img']['size'] > $maxFileSize) {
            ...
            if (!in_array($fileMimeType, $allowedMimeTypes)) {
                ...
                if (move_uploaded_file($_FILES['img']['tmp_name'], $imagePath)) {
                    ...
                    $stmt = mysqli_prepare($koneksi, "INSERT INTO entertainment (tgl, judul, subjudul, text, img, jenis) VALUES (?, ?, ?, ?, ?, ?)");
...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Tambah Berita Entertainment</h2>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="jenis" value="entertainment">

            <button type="submit" class="btn btn-primary">Tambah</button>
            <a href="../../index.php?page=entertainment" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
