...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $jenis = 'kesehatan'; // Default value for jenis (ubah dari ekonomi ke kesehatan)
        ...
        if ($_FILES['img']['size'] > $maxFileSize) {
            ...
            if (!in_array($fileMimeType, $allowedMimeTypes)) {
                ...
                if (move_uploaded_file($_FILES['img']['tmp_name'], $imagePath)) {
                    ...
                    $stmt = mysqli_prepare($koneksi, "INSERT INTO kesehatan (tgl, judul, subjudul, text, img, jenis) VALUES (?, ?, ?, ?, ?, ?)");
                    ...
                    if (mysqli_stmt_execute($stmt)) {
                        ...
                        header("Location: ../index.php?page=kesehatan");
                        exit;
                    } else {
...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Tambah Berita Kesehatan</h2>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="jenis" value="kesehatan">

            <button type="submit" class="btn btn-primary">Tambah</button>
            <a href="../index.php?page=kesehatan" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
