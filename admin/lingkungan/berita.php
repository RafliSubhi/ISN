...
<body>
    <div class="container mt-2">
        <h2 class="mb-4">Berita Lingkungan</h2>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    if (isset($_POST['btncari']) && !empty($_POST['pencarian'])) {
                        ...
                        $sql = mysqli_query($koneksi, "SELECT * FROM lingkungan WHERE judul LIKE '%" . mysqli_real_escape_string($koneksi, $pencarian) . "%'");
                    } else {
                        $sql = mysqli_query($koneksi, "SELECT * FROM lingkungan");
                    }
                    ...
                    ?>
                        <tr>
                            ...
                            <td><img src="lingkungan/<?php echo htmlspecialchars($data['img']); ?>" alt="Image" width="50"></td>
                            <td class="text-center">
                                <a href="lingkungan/berita_edit.php?id=<?php echo $data['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="lingkungan/berita_hapus.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin akan menghapus data?');">Hapus</a>
                            </td>
                        </tr>
                    <?php
                    }
        ...
        <a href="lingkungan/berita_tambah.php" class="btn btn-primary" role="button">Tambah Berita</a>
    </div>
    <!-- BOOTSTRAP -->
