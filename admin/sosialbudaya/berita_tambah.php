...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $jenis = 'sosialbudaya'; // Default value for jenis (ubah dari ekonomi ke kesehatan)
        ...
        if ($_FILES['img']['size'] > $maxFileSize) {
            ...
            if (!in_array($fileMimeType, $allowedMimeTypes)) {
                ...
                if (move_uploaded_file($_FILES['img']['tmp_name'], $imagePath)) {
                    ...
                    $stmt = mysqli_prepare($koneksi, "INSERT INTO sosialbudaya (tgl, judul, subjudul, text, img, jenis) VALUES (?, ?, ?, ?, ?, ?)");
                    ...
                    if (mysqli_stmt_execute($stmt)) {
                        ...
                        header("Location: ../index.php?page=sosialbudaya");
                        exit;
                    } else {
...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Tambah Berita Sosial&Budaya</h2>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="jenis" value="sosialbudaya">

            <button type="submit" class="btn btn-primary">Tambah</button>
            <a href="../index.php?page=sosialbudaya" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
