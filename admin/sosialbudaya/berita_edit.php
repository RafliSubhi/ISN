...
if (isset($_GET['id'])) {
    ...
    $sql = mysqli_query($koneksi, "SELECT * FROM sosialbudaya WHERE id = '$id'");
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($errorMessage)) {
            $updateQuery = "UPDATE sosialbudaya SET tgl = '$tgl', judul = '$judul', subjudul = '$subjudul', text = '$text', img = '$imgPath' WHERE id = '$id'";

            if (mysqli_query($koneksi, $updateQuery)) {
                echo "<script>alert('Data berhasil diperbarui!'); window.location.href = '../index.php?page=sosialbudaya';</script>";
            } else {
...
<body>
    <div class="container mt-5">
        <h2>Edit Berita Sosial&Budaya</h2>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="../index.php?page=sosialbudaya" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
